...
android {
    namespace = "com.example.vc_client_android_app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.valleycomputers.client"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // Support for existing XML layouts and Fragments
    implementation("androidx.appcompat:appcompat:1.7.0")
    implementation("com.google.android.material:material:1.12.0")
    implementation("androidx.constraintlayout:constraintlayout:2.2.0")
    implementation("androidx.fragment:fragment-ktx:1.8.5")

    // Firebase (Added for release requirements)
